		...
		WP_CHINA_YES::createSection( $this->prefix, [
			...
			'fields' => [
	            ...
	            'default'  => false,
					'title'    => '云桥更新',
					'subtitle' => '是否启用更新加速',
					'desc'     => '启用文派云桥更新通道；通道不可用时自动回到 WordPress.org。此开关不代表同意发送遥测。',
				],
				[
					'id'         => 'telemetry',
					'type'       => 'switcher',
					'default'    => false,
					'title'      => '匿名运行数据',
					'subtitle'   => '默认关闭，主动同意后发送',
					'desc'       => '每天最多发送一次插件版本、WordPress/PHP/MySQL 版本、语言和已启用插件的 slug/版本，用于兼容性分析；不发送订单、用户、商品、运输区域或主题模板数据。',
					'dependency' => [ 'bridge', '==', 'true' ],
				],
				[
					'id'         => 'telemetry_site_url',
					'type'       => 'switcher',
					'default'    => false,
					'title'      => '随遥测发送站点地址',
					'subtitle'   => '默认不发送站点 URL',
					'desc'       => '仅在需要按站点排查云桥兼容问题时开启。',
					'dependency' => [ 'telemetry', '==', 'true' ],
				],
				[
					'id'       => 'arkpress',
					'type'     => 'switcher',
