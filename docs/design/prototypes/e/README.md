...
认可记录：[`APPROVAL.md`](APPROVAL.md)。规格：[`../../admin-ui-spec.md`](../../admin-ui-spec.md) v2.0。视觉值：[`DESIGN-E.md`](DESIGN-E.md)。
...
| 文件 | 页面 · 状态 | 规格编号 |
|---|---|---|
| `overview-domestic.html` | 概览 · 国内站正常 | SH-01–08, OV-10/10a/10b/10c, OV-12/12a, OV-13, OV-14, OV-15 |
| `overview-crossborder.html` | 概览 · 跨境站正常（未绑定） | 同上 + OV-11（绑定本站） |
| `overview-degraded.html` | 概览 · 降级（镜像回退） | OV-16, OV-10b（3/4）, OV-13 降级行 |
| `overview-empty.html` | 概览 · 刚安装 | OV-08, SH-04（刚安装） |
| `overview-recovery.html` | 概览 · 恢复模式 | OV-01, OV-10b（已停用） |
...
| `services.html` | 服务 · 未绑定 | SV-01, SV-10（空态变体） |
| `services-pending.html` | 服务 · 绑定中 | SV-02 |
| `services-bound.html` | 服务 · 已绑定 | SV-03, SV-11, SV-07 |
