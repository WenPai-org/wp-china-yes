<?php
/**
 * PUT /network-settings ignores body profile_confirmed_at and stamps when profile is present.
 *
...
/**
 * Network PUT stamp matches site PUT.
 */
class NetworkSettingsProfileConfirmedTest extends TestCase {
	 ...
	 */
	private function controller(): NetworkSettingsController {
		return new NetworkSettingsController( new DocumentWriter( new Repository() ) );
	}
}
