<h2>
    <?php esc_html_e('API keys','wp-china-yes')?>
</h2>
<p>
...
<p>
    <a href="<?php echo esc_url(apply_filters('loco_external','https://localise.biz/wordpress/plugin/manual/providers'))?>" target="_blank"><?php esc_html_e('Full documentation','wp-china-yes')?></a>
</p>
